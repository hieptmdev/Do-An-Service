...
public class ChartData {
    private double thang1 = 0;
    private double thang2 = 0;
    private double thang3 = 0;
    private double thang4 = 0;
    private double thang5 = 0;
    private double thang6 = 0;
    private double thang7 = 0;
    private double thang8 = 0;
    private double thang9 = 0;
    private double thang10 = 0;
    private double thang11 = 0;
    private double thang12 = 0;
