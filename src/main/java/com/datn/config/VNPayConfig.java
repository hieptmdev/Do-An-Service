...
public class VNPayConfig {
    ...
    public static String vnp_Returnurl = "http://localhost:4200/result-checkout";
    public static String vnp_TmnCode = "MJCJKAWS";
    public static String vnp_HashSecret = "BTLINKXACSHWVYMQEBHBALJREBBXKKIK";
